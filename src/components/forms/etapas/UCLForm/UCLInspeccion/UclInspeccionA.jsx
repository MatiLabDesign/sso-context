...
//revisar si se puede cambiar el archivo css sin que alla modificaciones no deseadas
...
const UclInspeccionA = () => {
      ...
      if (inspeccionId) {
        ...
        if (result.isConfirmed) {
          ...
          if (modeloEquipoActual && tipoEquipoActual) {
            navigate(
              `/dashboard/etapa/inspeccion${tipoEquipoActual}B`
            );
          } else {
  ...
  const handleClick = (e) => {
    e.preventDefault();
    navigate(`/dashboard/etapa/inspeccion${tipoEquipo}B`);
  };
  ...
  return (
    <form className="recepcion-form" onSubmit={handleSubmit(onSubmit)}>
      <h3 className="form-title">Inspección UCL a</h3>
            ...
            <div className="item-field">
              ...
              <div className="item-tittle">
                ...
                <input
                  ...
                  {...register(`lubricantes.${ok}`)}
                  checked={watch(`lubricantes.${ok}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  type="checkbox"
                  className="radio-input"
                  {...register(`lubricantes.${pm}`)}
                  checked={watch(`lubricantes.${pm}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  type="checkbox"
                  className="radio-input"
                  {...register(`lubricantes.${agua}`)}
                  checked={watch(`lubricantes.${agua}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  type="checkbox"
                  className="radio-input"
                  {...register(`lubricantes.${sucio}`)}
                  checked={watch(`lubricantes.${sucio}`)}
                />
              </div>
              <div className="item-tittle">
                <input
          ...
          <div className="item-section" key={item.label}>
            ...
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`inversor.${item.ok}`)}
                checked={watch(`inversor.${item.ok}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`inversor.${item.reten}`)}
                checked={watch(`inversor.${item.reten}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`inversor.${item.rodamiento}`)}
                checked={watch(`inversor.${item.rodamiento}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`inversor.${item.diametro}`)}
                checked={watch(`inversor.${item.diametro}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`inversor.${item.deformado}`)}
                checked={watch(`inversor.${item.deformado}`)}
              />
            </div>
            <div className="item-tittle">
              <input
                className="form-input"
                {...register(`inversor.${item.esp}`)}
                placeholder="Especificar"
              />
            </div>
          </div>
