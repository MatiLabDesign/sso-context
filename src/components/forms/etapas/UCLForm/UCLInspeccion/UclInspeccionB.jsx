...
import "../../PCPForm/PcpRecepcion2.css";
...
import inspeccionUCL from "../../../../../data/inspeccionUCL";
import { INSPECCION_B_ITEMS_UCL } from "../../../../../constants/INSPECCION_ITEMS_UCL";
...
const UclInspeccionB = () => {
  ...
  useEffect(() => {
    if (otActual) {
      ...
      if (otActual.inspeccionUcl && otActual.inspeccionUcl.id) {
        console.log("✅ ID de Inspección UCL encontrada:", otActual.inspeccionUcl.id);
        // setInspecionId(otActual.inspeccionUcl.id);
      } else {
        console.warn(
          "⚠️ Advertencia: `otActual.inspeccionUcl` no tiene un ID válido."
        );
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (inspeccionId) {
        ...
        if (result.isConfirmed) {
          await updateInspeccionUcl(inspeccionId, data);
        ...
        console.log("No existe Id de Inspección...");
      }
    } catch (error) {
  ...
  const handleClick = (e) => {
    e.preventDefault();
    navigate(`/dashboard/etapa/inspeccion${tipoEquipo}C`);
  };
  ...
  return (
    <form className="recepcion-form" onSubmit={handleSubmit(onSubmit)}>
      <h3 className="form-title">Inspección UCL vvv</h3>
      ...
      <div className="lista-container">
        <h3>Rodamientos</h3>
        {INSPECCION_B_ITEMS_UCL.rodamientos.map(({ ok, pm, agua, sucio, esp, label }) => (
            ...
            <div className="item-field">
              ...
              <div className="item-tittle">
                ...
                <input
                  ...
                  {...register(`rodamientos.${ok}`)}
                  checked={watch(`rodamientos.${ok}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  type="checkbox"
                  className="radio-input"
                  {...register(`rodamientos.${pm}`)}
                  checked={watch(`rodamientos.${pm}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  type="checkbox"
                  className="radio-input"
                  {...register(`rodamientos.${agua}`)}
                  checked={watch(`rodamientos.${agua}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  type="checkbox"
                  className="radio-input"
                  {...register(`rodamientos.${sucio}`)}
                  checked={watch(`rodamientos.${sucio}`)}
                />
              </div>
              <div className="item-tittle">
                <input
        ...
        <h3>Transmisión</h3>
        {INSPECCION_B_ITEMS_UCL.transmision.map((item) => (
          <div className="item-section" key={item.label}>
            ...
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`Transmision.${item.ok}`)}
                checked={watch(`Transmision.${item.ok}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`Transmision.${item.reten}`)}
                checked={watch(`Transmision.${item.reten}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`Transmision.${item.rodamiento}`)}
                checked={watch(`Transmision.${item.rodamiento}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`Transmision.${item.diametro}`)}
                checked={watch(`Transmision.${item.diametro}`)}
              />
            </div>
            <div className="item-tittle">
              ...
              <input
                type="checkbox"
                className="radio-input"
                {...register(`Transmision.${item.deformado}`)}
                checked={watch(`Transmision.${item.deformado}`)}
              />
            </div>
            <div className="item-tittle">
              <input
                className="form-input"
                {...register(`Transmision.${item.esp}`)}
                placeholder="Especificar"
              />
            </div>
          </div>
