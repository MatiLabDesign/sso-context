...
import { INSPECCION_PCPCOUGARB_ITEMS } from "../../../../../constants/INSPECCION_PCPCOUGAR_ITEMS";

const PcpInspeccionCougarB = () => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  useEffect(() => {
    if (otActual) {
      ...
      if (otActual.inspeccionPcpCougar && otActual.inspeccionPcpCougar.id) {
  ...
  return (
    <form className="recepcion-form" onSubmit={handleSubmit(onSubmit)}>
      <h3 className="form-title">Inspección Cougar B</h3>
      ...
      <div className="lista-container">
        <h3>Rodamientos</h3>
        {INSPECCION_PCPCOUGARB_ITEMS.rodamientoPcpCoguar.map((item, index) => (
            ...
            <div className="item-field">
              ...
              <div className="item-tittle">
                ...
                <input
                  ...
                  type="checkbox"
                  {...register(`rodamientoPcpCougar.${item.ok}`)}
                  checked={watch(`rodamientoPcpCougar.${item.ok}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`rodamientoPcpCougar.${item.picado}`)}
                  checked={watch(`rodamientoPcpCougar.${item.picado}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`rodamientoPcpCougar.${item.laminado}`)}
                  checked={watch(`rodamientoPcpCougar.${item.laminado}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`rodamientoPcpCougar.${item.fallaEnJaula}`)}
                  checked={watch(`rodamientoPcpCougar.${item.fallaEnJaula}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`rodamientoPcpCougar.${item.desgaste}`)}
                  checked={watch(`rodamientoPcpCougar.${item.desgaste}`)}
                />
              </div>
              <div className="item-tittle">
                <input
                  className="form-input"
                  {...register(`rodamientoPcpCougar.${item.esp}`)}
        ...
        {INSPECCION_PCPCOUGARB_ITEMS.transmisionFrenoPcpCoguar.map((item, index) => (
          <div className="item-section" key={index}>
            <div className="item-field">
              <div className="item-tittle">
                <h4 className="item-title">{item.label}</h4>
              ...
              <div className="item-tittle">
                ...
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`transmisionFrenoPcpCougar.${item.ok}`)}
                  checked={watch(`transmisionFrenoPcpCougar.${item.ok}`)}
                />
              </div>
              <div className="item-tittle">
                <label className="form-label-1">Picado</label>
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`transmisionFrenoPcpCougar.${item.picado}`)}
                  checked={watch(`transmisionFrenoPcpCougar.${item.picado}`)}
                />
              </div>
              <div className="item-tittle">
                <label className="form-label-1">Desgaste</label>
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`transmisionFrenoPcpCougar.${item.desgastado}`)}
                  checked={watch(`transmisionFrenoPcpCougar.${item.desgastado}`)}
                />
              </div>
              <div className="item-tittle">
                ...
                <input
                  className="radio-input"
                  type="checkbox"
                  {...register(`transmisionFrenoPcpCougar.${item.roto}`)}
                  checked={watch(`transmisionFrenoPcpCougar.${item.roto}`)}
                />
              </div>
              <div className="item-tittle">
                <input
                  className="form-input"
                  {...register(`transmisionFrenoPcpCougar.${item.esp}`)}
                  placeholder="Especificar"
                />
              </div>
            </div>
...
export default PcpInspeccionCougarB;
